...
module.exports = {
    ...
    connect(_socket) {
        ...
        _socket.addListener('end', () => { console.log("Socket Ended!"); _socket["__connected"] = false; });
        _socket.addListener('timeout', () => { console.log("Socket Timeout!"); _socket.end(() => { }); });
        _socket.addListener('close', hadError => { console.log("Socket Closed!"); _socket["__connected"] = false; setTimeout(() => (_socket.client.connect()), 300000); });
