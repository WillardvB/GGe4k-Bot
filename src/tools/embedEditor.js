...
function wijzigReactierollenBericht(client) {
	var embed = new EmbedBuilder()
		...
		.addFields({ name: ":mobile_phone: (E4K)", "Klik op deze emoji voor de E4K rol.", false)
		.addFields({ name: ":desktop: (Empire)", "Klik op deze emoji voor de Empire rol.", false)
		.addFields({ name: ".:bell:.", "Klik op deze emoji voor de Mededeling rol.", false);
	client.channels.cache
