...
function stuurWelkomstBerichtMetRegels(client) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription('Deze Discordserver is er voor de community van de Nederlandse GGE en E4K server. De server verbetert het contact tussen bgs en hier kan iedereen zijn/haar tips & tricks delen. Voordat je verder gaat, lees eerst even dit bericht.' + '\n' + '\n' + 'Mocht je problemen ondervinden tijdens het gebruik van de server, contacteer een <@&' + rollen.server.moderator + '>. Zij zullen je verder helpen.' + '\n' + '\n' + 'Hulpvolle links:' + '\n' + '- Discord uitnodiging: https://discord.gg/w6YSB4kHQu' + '\n' + '- GGE support: https://support.goodgamestudios.com/')
        .setColor('#02c2e6')
...
function wijzigReactierollenBericht(client) {
    const embed = new EmbedBuilder()
        ...
        .setAuthor({
            name: "WillardvB", iconURL: "https://icon-library.com/images/blue-discord-icon/blue-discord-icon-17.jpg"
        })
        ...
        .addFields({
            name: ":mobile_phone: (E4K)", value: "Klik op deze emoji voor de E4K rol.", inline: false
        }, {name: ":desktop: (Empire)", value: "Klik op deze emoji voor de Empire rol.", inline: false}, {
            name: ".:bell:.", value: "Klik op deze emoji voor de Mededeling rol.", inline: false
        });
