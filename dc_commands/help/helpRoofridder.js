...
module.exports = {
	name: 'help roofridder',
	description: 'Toont alle mogelijke roofridder commands!',
	execute(client, message) {
    embed = new MessageEmbed() 
      .setTitle("**Help!**")
      .setDescription("Alle mogelijke roofridder commands.")
      .setColor("#FF0000")
      .setFooter(footerTekst, footerAfbeelding)
      .setTimestamp()
      .setThumbnail(thumbnail);
    client.rrCommands.map(command =>{
